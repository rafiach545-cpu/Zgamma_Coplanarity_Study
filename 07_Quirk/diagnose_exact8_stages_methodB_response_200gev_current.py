...
INPUT = ROOT / "07_Quirk" / "quirk_hits_methodB_truth_200gev.csv"
    ...
    for _, oi, oj in outer_pairs:
        for _, si, sj in second_pairs:
            ...
            for lyr in GROWTH_LAYERS:
                ...
                # Exactly as current production Exact8:
                # compute plane once at start of physical layer.
...
OUTPUT = ROOT / "07_Quirk" / "quirk_exact8_stage_diagnostic_200gev_current.csv"
