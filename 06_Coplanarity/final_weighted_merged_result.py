...
HITS = "05_Tracking/converted_photon_hits_weighted_cylinders_eta18_final_response.csv"
...
pass_w = out.loc[out["found"],"weight"].sum()

print("\n===== MERGED FULL RESPONSE WEIGHTED RESULT =====")
print("Events:", len(out))
print("Found:", int(out["found"].sum()))
print("Total effective weight:", total_w)
print("Passed effective weight:", pass_w)
print("Weighted acceptance:", pass_w/total_w)
...
out.to_csv(
    "06_Coplanarity/merged_full_response_weighted_events.csv",
    index=False
)

summary.to_csv(
    "06_Coplanarity/merged_full_response_weighted_ptbins.csv",
    index=False
)

print("\nSaved:")
print("06_Coplanarity/merged_full_response_weighted_events.csv")
print("06_Coplanarity/merged_full_response_weighted_ptbins.csv")
