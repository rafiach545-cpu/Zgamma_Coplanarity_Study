...
out_path = ROOT / "06_Coplanarity" / "conversion_coplanarity_highstat_results.csv"
...
for event, ev in hits.groupby("event"):
    ...
    # TrackML layer_id repeats between detector volumes.
    # Encode each physical barrel surface uniquely.
    layers = (
