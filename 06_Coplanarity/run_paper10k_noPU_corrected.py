...
META = (
    pd.read_csv(
        ROOT / "04_Conversion/converted_pairs_weighted_paper10k_barrel_eta18.csv"
    )
    .sort_values("event")
...
PRE = pd.read_csv(
    ROOT / "05_Tracking/converted_photon_hits_weighted_cylinders_paper10k_eta18_detector_response_beamspot.csv"
)

POST = pd.read_csv(
    ROOT / "05_Tracking/converted_photon_hits_weighted_cylinders_paper10k_eta18_final_response_beamspot.csv"
)
...
run(
    PRE,
    "PRE-MERGE",
    ROOT / "06_Coplanarity/paper10k_noPU_premerge_exact8_corrected.csv",
)

run(
    POST,
    "POST-MERGE",
    ROOT / "06_Coplanarity/paper10k_noPU_postmerge_exact8_corrected.csv",
)
